<template>
  <a-card :bordered="false" class="card-area">
          ...
          <div :class="advanced ? null: 'fold'">
            <a-col :md="12" :sm="24">
              <a-form-item
                ...
                <a-input v-model="queryParams.rssName"/>
              </a-form-item>
            </a-col>
            <a-col :md="12" :sm="24">
              <a-form-item
    ...
    <div>
      ...
      <a-table ref="TableInfo"
        ...
        <template slot="image" slot-scope="text, record">
          <img  style="width:100px;heigth:100px" slot="image" :src=record.image />
        </template>
        ...
        <template slot="operation" slot-scope="text, record">
          ...
          <a-icon type="eye" theme="outlined"
                  @click="rssShow(record)" title="查看详情"></a-icon>
    ...
    <ScenicInfo
      @close="handleScenicInfoClose"
      :scenicData="rssInfo.data"
      :scenicVisiable="rssInfo.visiable">
    </ScenicInfo>
  </a-card>
</template>
...
<script>
  ...
  import ScenicInfo from './RssView'

  export default {
    name: 'User',
    components: {DeptInputTree, RangeDate,ScenicInfo},
    data() {
      return {
        advanced: false,
        scenicInfo: {
    ...
    computed: {
      columns() {
        ...
        return [{
          title: 'Rss名称',
          dataIndex: 'rssName',
          sorter: (a, b) => a.rssName.length - b.rssName.length,
          sortOrder: sortedInfo.columnKey === 'rssName' && sortedInfo.order
        }, {
          title: '上传日期',
    ...
    methods: {
      ...
      rssShow(record) {
        this.rssInfo.visiable = true;
        this.rssInfo.data = record;
      },
      handleScenicInfoClose() {
        this.rssInfo.visiable = false;
      },
      handleUserAddClose() {
      ...
      scenicShow(record) {
        this.scenicInfo.visiable = true;
        this.scenicInfo.data = record;
      },
      handleScenicInfoClose() {
        this.scenicInfo.visiable = false;
      },
      handleUserEditClose() {
      ...
      batchDelete() {
        ...
        this.$confirm({
          ...
          onOk() {
            ...
            that.$delete('/cos/rss-history/'+ids,).then(() => {
