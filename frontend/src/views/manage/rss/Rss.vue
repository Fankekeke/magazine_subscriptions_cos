          ...
          <div :class="advanced ? null: 'fold'">
            ...
            <a-col :md="12" :sm="24">
              <a-form-item
                ...
                :labelCol="{span: 4}"
                :wrapperCol="{span: 18, offset: 2}">
                <a-input v-model="queryParams.rssAuthor"/>
              </a-form-item>
            </a-col>
          </div>
      ...
      <a-table ref="TableInfo"
        ...
        <template slot="operation" slot-scope="text, record">
          <a-icon v-hasPermission="['user:update']" type="setting" theme="twoTone" twoToneColor="#4a9ff5"
                  @click="edit(record)" title="修改Rss"></a-icon>
...
<script>
  ...
  import UserAdd from './RssAdd'
  import UserEdit from './RssEdit'
      ...
      batchDelete() {
        ...
        this.$confirm({
          ...
          onOk() {
            ...
            that.$delete('/cos/rss-info/'+ids,).then(() => {
